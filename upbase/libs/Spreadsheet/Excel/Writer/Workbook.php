...
require_once('upbase/libs/Spreadsheet/Excel/Writer/Format.php');
require_once('upbase/libs/Spreadsheet/Excel/Writer/BIFFwriter.php');
require_once('upbase/libs/Spreadsheet/Excel/Writer/Worksheet.php');
require_once('upbase/libs/Spreadsheet/Excel/Writer/Parser.php');
require_once('upbase/libs/OLE/PPS/Root.php');
require_once('upbase/libs/OLE/PPS/File.php');
